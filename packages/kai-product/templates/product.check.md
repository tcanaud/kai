...
npx @tcanaud/kai-product check

# JSON output for programmatic use
npx @tcanaud/kai-product check --json
```
...
If issues are found, suggest appropriate remediation (e.g., `kai-product reindex` for index desync).
